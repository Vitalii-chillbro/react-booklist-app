...
export const toggleRead = createAsyncThunk('posts/toggleRead', async (payload) => {
...
export const eraseBook = createAsyncThunk('posts/eraseBook', async (payload) => {
  await deleteDoc(doc(db, "books", payload));
  return payload;
});

export const addBook = createAsyncThunk('posts/addBook', async (payload) => {
